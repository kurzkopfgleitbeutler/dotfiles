...
alias dlp='youtube-dl -x --output "%(playlist_index)s_%(title)s-%(id)s.%(ext)s" --restrict-filenames --ignore-errors -f bestaudio --write-description --add-metadata --xattrs --write-sub --sub-lang en,en-GB,de --batch-file urls'
